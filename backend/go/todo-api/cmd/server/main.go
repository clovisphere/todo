// Package main is the entry point to the server. It reads configuration, sets up logging and error handler
// handles signals from OS, and starts and stops the server.
package main
...
func start() int {
	...
	port := getIntOrDefault("PORT", 9000)
